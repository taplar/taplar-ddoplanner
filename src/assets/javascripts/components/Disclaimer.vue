<template>
	<div class="disclaimer font-size-3">
		<p class="no-margin-top">
			<em>DDO Planner</em> is a fan site for the <a href="http://www.ddo.com/" target="_new" class="external-link">MMORPG Dungeons &amp; Dragons Online</a>.
		</p>
